...
(15, 'raff', 'Srapyan', 'hianali kayqeq patrastel', '2023-01-10 13:52:15', '2023-01-10 13:52:15');
...
--
-- Table structure for table `patvers`
--
...
--
-- Dumping data for table `patvers`
--

INSERT INTO `patvers` (`id`, `hamar`, `anun`, `azganun`, `qanak`, `heraxos`, `created_at`, `updated_at`) VALUES
(23, 7, 'anun', 'yan', 5, 77272082, '2023-01-10 13:51:00', '2023-01-10 13:51:00');
...
(13, 'http://cdn.globalso.com/xingzirain/115886-5.jpg', 'կանացի կոշիկներ', 15000, 'Արտադրվելե Գերմանիայում', '2023-01-04 09:52:04', '2023-01-04 09:52:04');
...
(3, 'raf', 'admin@admin', NULL, '$2y$10$iXPSKup1YP/3fbrP8hoDvOvFFQ0vye9FkKQE8jkMtXQhLvI6HK.t.', NULL, '2023-01-09 14:05:11', '2023-01-09 14:05:11');
...
--
-- AUTO_INCREMENT for table `patvers`
--
ALTER TABLE `patvers`
